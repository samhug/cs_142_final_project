...
public abstract class EventHandler {
	...
	public <T extends EventObject> void addEventListener(Class<T> eventType, Listener listener) {
		...
		if ((eventListeners = eventListenerMap.get(eventType)) == null) {
			...
			eventListenerMap.put((Class<EventObject>)eventType, eventListeners);
		}
		
		eventListeners.add(listener);
	}
	
	public <T extends EventObject> void removeEventListener(Class<T> eventType, Listener listener) {
